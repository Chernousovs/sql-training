import { ACTORS, KEYWORDS, MOVIES, MOVIE_DIRECTORS, MOVIE_GENRES, MOVIE_KEYWORDS, MOVIE_PRODUCTION_COMPANIES, MOVIE_RATINGS, DIRECTORS, GENRES, PRODUCTION_COMPANIES } from "../table-names";
